test_parameter <- function(n,n.real.cells,real.cells,pK,pN,data,orig.commands,PCs,sct)  {
...
paramSweep_v3 <- function(seu, PCs=1:10, sct = FALSE) {
  ...
  output2 = mclapply(as.list(1:length(pN)),FUN=test_parameter,n.real.cells,real.cells,pK,pN,data,orig.commands,PCs,sct)  
  stopCluster(cl)
